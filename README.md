...
## Running SLACC
Make sure [SLACC is setup](https://github.com/DynamicCodeSearch/SLACC/blob/ICSE20/INSTALL.md) before trying to run the following scripts. Ensure that the database is running as a daemon. Check this by running `mongo` on the terminal. If not, start mongo as a daemon process. 
