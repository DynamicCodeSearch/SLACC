package CodeJam.Y11R5P1.mystic;
...
public class Solution {
    ...
    static double area(Point[] p, double bnd) {
        double res = 0.0;
    ...
    public void go() throws Exception {
        ...
        for (int caseNum = 1; caseNum <= caseCnt; caseNum++) {
            ...
            for (int i = 0; i < L; i++) lower[i] = new Point(sc.nextInt(), sc.nextInt() + 1000);
            Point[] upper = new Point[U];
            for (int i = 0; i < U; i++) upper[i] = new Point(sc.nextInt(), sc.nextInt() + 1000);
