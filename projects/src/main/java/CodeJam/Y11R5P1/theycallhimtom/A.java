package CodeJam.Y11R5P1.theycallhimtom;
...
public class A {
    ...
    public static void main(String[] args) {
        ...
        for (int zz = 1; zz <= T; zz++) {
            ...
            for (int i = 0; i < NL; i++) L[i] = new Point(in.nextInt(), in.nextInt() + 1000);
            Point[] U = new Point[NU];
            for (int i = 0; i < NU; i++) U[i] = new Point(in.nextInt(), in.nextInt() + 1000);
            double start = 0.0;
