package CodeJam.Y13R5P1.mikhailOK;
...
public class A {
    ...
    static double calcOurWinning(long budget, Long[] x, int winningThings, long lowestBet) {
        long payMoney = 0;
    ...
    static long calcMaxBet(long budget, Long[] x, int winningThings) {
    ...
    static boolean canDo(Long budget, Long[] x, int winningThings, long lowestBet) {
        long payMoney = 0;
